...
@Autonomous
public class TestCraterFromLatchTensorAutoOp extends LinearOpMode {
...
//    private DcMotor extension;
    ...
    private static int SelectionDirection = 3;
...
//        fingers = hardwareMap.get(CRServo.class, "fingers");
        ...
        if (tfod != null) {
            ...
            telemetry.update();
            sleep(pauseMS);
            while (objectsDetected != 3 && !opModeIsActive()) {
        ...
        public void driveFromCratertoDepot () {
            ...
            encoderDrive(DRIVE_SPEED * turningConstant, 3, 3, 5.0);
            if (!opModeIsActive()) return;
            //GO INTO DEPOT!!
            encoderDrive(DRIVE_SPEED, 5.25, -5.25, 5.0);
            encoderDrive(DRIVE_SPEED * turningConstant, -0.33, -0.33, 5.0);
        ...
        public void driveBackToCrater () {
            ...
            encoderDrive(DRIVE_SPEED, -11.5, 11.5, 20.0);
        ...
        */
        ...
        public void hitLeft () {
            ...
            encoderDrive(DRIVE_SPEED * turningConstant, 1.75, 1.75, 5.0);
            // First forward move to move towards the minerals.
            ...
            encoderDrive(DRIVE_SPEED, -6, 6, 5.0);
            //Turn right to point back towards lander
            encoderDrive(DRIVE_SPEED * turningConstant, -1.75, -1.75, 5.0);
        }
        public void hitRight () {
            ...
            encoderDrive(DRIVE_SPEED, -6, 6, 5.0);
            //Turn left to point back towards lander
            encoderDrive(DRIVE_SPEED * turningConstant, 1.75, 1.75, 5.0);
        }
    }
